			...
			if(vOLDLength[stepID] > 0) {
				switch(vOLDDir[stepID]) {
					...
					case eBOTRIGHTBOSS: // BOT & RIGHT
						...
						break;
					case eBOSSTEXT1:
						CCore::getMap()->addText(vOLDLength[stepID], CCFG::GAME_HEIGHT - 16 - 9*32, "THANK YOU STUDENTz");
						vOLDLength[stepID] = 0;
						break;
					case eBOSSTEXT2:
						CCore::getMap()->addText(vOLDLength[stepID] + 16, CCFG::GAME_HEIGHT - 16 - 7*32, "BUT THE BUGZ IS IN");
						CCore::getMap()->addText(vOLDLength[stepID] + 16, CCFG::GAME_HEIGHT - 16 - 6*32, "ANOTHER CASTLEz");
						vOLDLength[stepID] = 0;
						break;
					case eENDGAMEBOSSTEXT1:
						CCore::getMap()->addText(vOLDLength[stepID], CCFG::GAME_HEIGHT - 16 - 9*32, "THANK YOU BUGHUNTERz");
						vOLDLength[stepID] = 0;
						break;
					case eENDGAMEBOSSTEXT2:
						CCore::getMap()->addText(vOLDLength[stepID] + 16, CCFG::GAME_HEIGHT - 16 - 7*32, "YOUR TEST IS OVER.");
						vOLDLength[stepID] = 0;
						break;
					case eMARIOSPRITE1:
