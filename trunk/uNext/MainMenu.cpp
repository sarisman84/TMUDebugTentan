...
{
	MenuOption* player = new MenuOption("1 PLAYER GAME", 178, 276);
	MenuOption* options = new MenuOption("OPTIONS", 222, 308);
	MenuOption* about = new MenuOption("ABOUT", 237, 340);

	this->lMO.push_back(player);

	this->lMO.push_back(options);

	this->lMO.push_back(about);
